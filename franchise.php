				...
				<article>
					...
					<div class="row">
						<div class="col-xs-12 col-md-offset-1 col-md-1 col-md-offset-1">
							<img src="http://i.imgur.com/OK9KunEs.jpg?1" target="blank">
						</div>
								...
								<div class="form-group">
									<div class="col-xs-12 col-md-offset-3 col-md-6">
										...
										<select class="form-control" id="sel1">
											...
											<option>de 5000 à 10000€</option>
											<option>de 10000 à 20000€</option>
											<option>de 20000 à 30000€</option>
											<option>plus de 30000€</option>
										</select>
									</div>
								</div>
									<div class="col-md-5"></div>
